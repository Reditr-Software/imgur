...
export interface ImgurApiResponse<T = Record<string, unknown> | Record<string, unknown>[] | string | string[] | boolean | ImageData | GalleryData | AlbumData | NewAlbumData | AccountData> {
    data: T;
    status: number;
    success: boolean;
}
